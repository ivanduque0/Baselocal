...
while True:
    try:
        ...
        cursorlocal.execute('CREATE TABLE IF NOT EXISTS dispositivos_informacion (id BIGINT PRIMARY KEY, dispositivo varchar(150), descripcion varchar(150), acceso varchar(150), tipo_dispositivo varchar(150), sistema varchar(150), tipo_acceso varchar(150))')
