        ...
        while True:
            ...
            if cambiarEstadoFotos:
                try:
                    ...
                    fotosLocal= cursorlocal.fetchall()
                    for fotolocal in fotosLocal:
                        estado=fotolocal[2]
                        id=fotolocal[0]
                        foto=fotolocal[1]
                        if estado==2:
                    ...
                    cambiarEstadoFotos=False
                except Exception as e:
                    print(f"{e} - fallo total cambiando estados de fotos")           

    except (Exception, psycopg2.Error) as error:
        print(f"{error} - fallo en hacer las consultas en base de datos de managerall")
        if connlocal:
            cursorlocal.close()
            connlocal.close()
    finally:
